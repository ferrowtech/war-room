...
const DAILY_TASKS = {
  EN: [
    ...
    { id: "secret_tasks",    label: "Complete Secret Tasks (Radar Tasks)", note: "" },
  ...
  RU: [
    ...
    { id: "secret_tasks",    label: "Выполнить Секретные задания (Задания Радара)", note: "" },
  ...
  FR: [
    ...
    { id: "secret_tasks",    label: "Completer les Taches secretes (Taches Radar)", note: "" },
